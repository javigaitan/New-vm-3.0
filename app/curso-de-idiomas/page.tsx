...
export default function CursoDeIdiomasPage() {
  useEffect(() => {
    window.scrollTo(0, 0)
  }, [])
      ...
      <main>
        <div className="container mx-auto px-4 py-7">
          ...
          <div className="w-full lg:w-1/2 p-4 flex flex-col justify-center items-center lg:items-start text-center lg:text-left lg:hidden">
            <h1 className="text-4xl font-bold mb-4 text-primary-vio">Cursos de Idiomas</h1>
          </div>
          ...
          <div className="flex flex-col md:flex-col lg:flex-row items-center lg:items-start">
            ...
            <div className="w-full lg:w-1/2 p-4 flex flex-col justify-center items-center lg:items-start text-center lg:text-left">
              ...
              <h1 className="text-4xl font-bold mb-4 text-primary-vio hidden lg:block">Cursos de Idiomas</h1>
              ...
              <div className="pt-10 pb-8">
                <Link href="https://wa.me/541170585095/?text=¡Hola,%20Vaga-Mundo!%20Quiero%20cotizar%20mi%20curso%20de%20idiomas!">
